...
def initialize():
	...
	f = open("C:\\Users\\Jangra\\OneDrive\\Desktop\\AI Project\\AI_Project-master\\q_table.json")
	q_table = json.load(f)
	f.close()

	# selenium.webdriver module provides all the WebDriver implementations
	s = Service('C:\\Users\\Jangra\\OneDrive\\Desktop\\AI Project\\chromedriver.exe')
...
if __name__ == '__main__':
	...
	f = open("C:\\Users\\Jangra\\OneDrive\\Desktop\\AI Project\\AI_Project-master\\q_table.json", "w")
	json.dump(q_table, f)
	f.close()

	f = open("C:\\Users\\Jangra\\OneDrive\\Desktop\\AI Project\\AI_Project-master\\scores.txt", "a")
	f.write(str(scores))
	f.write("\n")
	f.close()
